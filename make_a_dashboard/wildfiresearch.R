...
root <- './data/wildfire_datasets/'     #set where we put our data
all_wild_data <- read.csv(paste0(root, 'kaggle_wildfire_dataset.csv'), stringsAsFactors = FALSE) #read in big wildfire dataset form kaggle
...
write.csv(all_CA_wild, paste0(root, "all_CA_wild.csv")) #save cleaned CA data in our specified date range
...
c1weather <- read.csv(paste0(root, "Oakland.csv"), stringsAsFactors = FALSE)
c2weather <- read.csv(paste0(root, "Benton.csv"), stringsAsFactors = FALSE)
c3weather <- read.csv(paste0(root, "Carmel Valley.csv"), stringsAsFactors = FALSE)
c4weather <- read.csv(paste0(root, "Scranton.csv"), stringsAsFactors = FALSE)
c5weather <- read.csv(paste0(root, "Fresno.csv"), stringsAsFactors = FALSE)
...
#exporting weather at this point
write.csv(Weather, paste0(root, "weather_combined.csv"))
