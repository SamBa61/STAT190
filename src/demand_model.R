...
saveRDS(results_BANC, file = "output/banc_results.rds")
# output to console that everything worked
cat("BANC results saved successfully\n")

saveRDS(results_CISO, file = "output/ciso_results.rds")
cat("CISO results saved successfully\n")

saveRDS(results_IID, file = "output/iid_results.rds")
cat("IID results saved successfully\n")

saveRDS(results_LDWP, file = "output/ldwp_results.rds")
cat("LWDP results saved successfully\n")

saveRDS(results_TIDC, file = "output/tidc_results.rds")
